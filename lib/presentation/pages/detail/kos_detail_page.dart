...
class _KosDetailPageState extends State<KosDetailPage> {
                  ...
                  PageView.builder(
                    ...
                    itemBuilder: (context, i) {
                      return kos.fotoUrls.isNotEmpty
                          ? Image.network(kos.fotoUrls[i],
                              fit: BoxFit.cover, width: double.infinity,
                              errorBuilder: (_, __, ___) => _photoPlaceholder(
                                  Icons.home_rounded))
                          : _photoPlaceholder(Icons.home_rounded);
                    },
                  ),
                  // Dots indicator
                ...
                children: [
                  ...
                  if (kos.jarak != null) ...[
                    ...
                    Row(children: [
                      ...
                      const SizedBox(width: 4),
                      Text('${kos.jarak!.toStringAsFixed(1)} km dari lokasi kamu',
                  ...
                  Row(children: [
                    ...
                    Text('(${kos.totalReview} ulasan)',
                        style: AppTextStyles.bodyMedium),
                  ]),
                  const SizedBox(height: 12),
                  _buildReviewItem('Budi S.', 5,
                      'Kamar bersih, pemilik ramah, lokasi strategis!'),
                  _buildReviewItem('Ani R.', 4,
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          const SizedBox(width: 8),
          Text(nama, style: AppTextStyles.titleMedium.copyWith(fontSize: 14)),
          const Spacer(),
  ...
  Widget _photoPlaceholder(IconData icon) {
    return Container(
      color: AppColors.surfaceVariant,
      child: Center(child: Icon(icon, size: 64, color: AppColors.textHint)),
    );
  }
